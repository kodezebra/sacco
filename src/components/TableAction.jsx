...
export default function TableAction({ 
  ...
  const baseClasses = "group inline-flex items-center gap-1.5 rounded-sm border border-stroke bg-white px-2.5 py-1.5 text-xs font-bold text-black shadow-xs transition-all hover:border-primary hover:text-primary active:scale-95";
